...
import com.example.wenda.tarucnfc.Activitys.EditFoodItemActivity;
...
public class AdapterFoodItem extends RecyclerView.Adapter<AdapterFoodItem.ViewHolder>{
    ...
    public AdapterFoodItem(Context context, List<FoodMenu> items, int itemLayout, AdapterCallBack adapterCallBack) {
